...
if apply_se:
    ...
    if aspect_equal_se:
        ax.set_aspect('equal')
    fig.tight_layout()
    plt.savefig('results/'+name+'_se.pdf', bbox_inches='tight')
    plt.show()
...
if apply_pca:
    ...
    if aspect_equal_pca:
        ax.set_aspect('equal')
    fig.tight_layout()
    plt.savefig('results/'+name+'_pca.pdf', bbox_inches='tight')
    plt.show()
...
if apply_lamp:
    ...
    fig.tight_layout()
    plt.savefig('results/'+name+'_lamp.pdf', bbox_inches='tight')
    plt.show()
...
if apply_tsne:
    ...
    ax.set_yticks([])
    fig.tight_layout()
    plt.savefig('results/'+name+'_tsne.pdf', bbox_inches='tight')
    plt.show()
...
if apply_umap:
    ...
    ax.set_yticks([])
    fig.tight_layout()
    plt.savefig('results/'+name+'_umap.pdf', bbox_inches='tight')
    plt.show()
